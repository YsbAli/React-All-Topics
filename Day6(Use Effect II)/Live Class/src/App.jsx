  ...
  return (
    <>
      <div className="App">
        ...
        {/* is show is true then show the Todos Component otherwise show null */}

        {show ? <Todos /> : null}  

        {/* {show ? <Countdown /> : null}   */}

        {/* {show ? <UseEffectPractice /> : null}   */}

        {/*on setShow, show value will be change like if true then false or if false then true  */}
